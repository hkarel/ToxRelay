...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        QString configFile = config::qdir() + "/toxrelay.conf";
...
//        usb::relay().start();
        ...
        chk_connect_q(&toxNet(), &ToxNet::internalMessage,
...
//        appl.sendSettings();
//        QMetaObject::invokeMethod(&appl, "clearHistory",  Qt::QueuedConnection);
