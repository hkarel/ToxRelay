...
Project {
    ...
    ToxBase {
        ...
        files: [
            ...
            toxPrefix + "toxcore/group_chats.c",
            toxPrefix + "toxcore/group_chats.h",
            toxPrefix + "toxcore/group_common.h",
            toxPrefix + "toxcore/group_connection.c",
            toxPrefix + "toxcore/group_connection.h",
            toxPrefix + "toxcore/group_moderation.c",
            toxPrefix + "toxcore/group_moderation.h",
            toxPrefix + "toxcore/group_onion_announce.c",
            toxPrefix + "toxcore/group_onion_announce.h",
            toxPrefix + "toxcore/group_pack.c",
            toxPrefix + "toxcore/group_pack.h",
            ...
            toxPrefix + "toxcore/shared_key_cache.c",
            toxPrefix + "toxcore/shared_key_cache.h",
